...
| **On-Device LLM Dialogue** | `Qwen3-0.6B Instruct` + `llama.cpp` | 100% Offline | Mobile + Desktop | v0.3.0 |
| **Translation Provider** | SQLite + Phrase KB + Morphology | 100% Offline | Mobile + Desktop | v0.3.0 |
